...
class MpcAgentTest(unittest.TestCase):
    ...
    def test_confidence_score(self):
        ...
        agent.scan(ground_truth)
        self.assertEqual(agent._confidence_score(), 5 / 9)

        agent.scan_radius = 10
        agent.scan(ground_truth)
        self.assertEqual(agent._confidence_score(), 1.0)
    ...
    def test_safety_penalty(self):
        ...
        ground_truth.fire[1][1] = FireLevel.BURNING
        agent.scan(ground_truth)
        self.assertAlmostEqual(agent._safety_penalty(), 1)
    ...
    def test_exploration_score(self):
        ...
        self.assertAlmostEqual(agent._exploration_score(), (6 + 1/3) / (3 * 3 + 1))
        ...
        self.assertEqual(agent._exploration_score(), 1.0)